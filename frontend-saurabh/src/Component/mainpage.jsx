    ...
    <div>
      ...
      <DIV2 className="calcdiv">
        ...
        <div className="text">
            ...
            <p>The type of loan you choose will affect your interest rate and your monthly payment, so it’s important to choose wisely. Here’s a look at different loan options for some common mortgage types. The interest rates displayed are averages, but you can find personalized rates here.</p>
